...
public class Card
  ...
  public static final int _BJ = 52;
  public static final int _RJ = 53;

  public static final int NUM_SUITS = 4;
  public static final int NUM_RANKS = 13;
  public static int NUM_CARDS = NUM_SUITS * NUM_RANKS ;
   ...
   */
  public Card(boolean jocker) {
      if (jocker)    NUM_CARDS  =NUM_SUITS * NUM_RANKS +2;
      _jocker = jocker;
    index = -1;
  }
   ...
   */
  public Card(int index, boolean jocker) {      
      if (jocker)    NUM_CARDS  =NUM_SUITS * NUM_RANKS +2;
      _jocker = jocker;
