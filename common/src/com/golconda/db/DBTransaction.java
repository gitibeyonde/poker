...
public class DBTransaction {
  ...
  static Logger _cat = Logger.getLogger(DBTransaction.class.getName());
...
// public String _comment;
  ...
  public static int addTransaction(DBPlayer p, String session, ModuleType mod, double amt, double play, double real, long trans_type, String comment) throws DBException  {
      ...
      dbt._module = mod;
      dbt._currency = TransactionType.isReal(trans_type)? CURRENCY_EURO : CURRENCY_USD;
  ...
  public int saveTrans(){
    ...
    public static synchronized DBTransaction[] getTransaction(String user) {
        Connection conn = null;
        PreparedStatement ps = null;
        ...
        public static synchronized DBTransaction[] getAllTransaction(int mt) {
            Connection conn = null;
            PreparedStatement ps = null;
            DBTransaction sp = null;
            Vector v = new Vector();
