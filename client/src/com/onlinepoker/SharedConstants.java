...
public final class SharedConstants {
    ...
    public static String chipToMoneyString$Right(double chip) {
        return moneyToString$Right(chip);
    }
    ...
    public static double roundDecimal(double value) {
        return Double.parseDouble(new DecimalFormat("###,##0.00", dfs).format(value).toString());
    }
    ...
    public static String moneyToString$Right(double money) {
        return new DecimalFormat("###,###,##0.00 €", dfs).format(money).toString();
    }
    
    public static String tourneyPointsToString(double points) {
        return new DecimalFormat("###,###,##0.00", dfs).format(points).toString();
    }
    
    public static String activePlayersString(int ap) {
    	return String.format("%06d", ap);
    }
    
    public static String activeTablesString(int at) {
    	return String.format("%05d", at);
    }
