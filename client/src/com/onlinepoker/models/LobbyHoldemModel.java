...
/**
   * Constructor.
   */
  public LobbyHoldemModel() {
    gameType = 1;//new PokerGameType(POKER_TYPE_HOLDEM);
  }

  public LobbyHoldemModel(GameEvent ge) {
    super(ge);
    name = ge.getGameName();
    ...
    {
    	String plr[] = plyr[i];
    	if(plr[6] != null && Integer.parseInt(plr[6]) > 0)
		{
    		isProPlayer = true;
    		break;
		}
   ...
   * Constructor.
   */
  public LobbyHoldemModel(LobbyTableModel model,
                          double lowBet,
                          double highBet,
                          double smallBlind,
                          double bigBlind
   ...
   * Constructor.
   */
  public LobbyHoldemModel(int id,
                          String name,
                          int gameType,
    ...
    super(name, gameType, playRealMoney, numPlayers,
          ...
          fee,avgPot,handsPerHour,playersPerFlop, ispro, stack, chips);
//    setGameLimit(gameLimit);
   ...
   * Constructor.
   */
  public LobbyHoldemModel(LobbyHoldemModel model) {
    copy(model);
  }
  ...
  public void copyWithoutSettings(LobbyTableModel model) {
    ...
    LobbyHoldemModel holdemModel = (LobbyHoldemModel) model;
    ...
    this.tournamentLevel = holdemModel.tournamentLevel;
  }
  ...
  public boolean equalsByFields(Object obj) {
    if (obj instanceof LobbyHoldemModel) {
      LobbyHoldemModel table = (LobbyHoldemModel) obj;
      return
