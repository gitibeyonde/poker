...
public class MyHandHistoryDialog extends JInternalFrame implements ActionListener
{
	...
	public MyHandHistoryDialog (JFrame frame, String title,
		String gid, long grid) {
		super();
...
//	}
    ...
    String url_str = sb.append(Utils.getURL()).append("/s/handhistory?gid=").append(gid.replace(" ", "%20"))
    				  .append("&grid=").append(grid).append("&pid=").append(ServerProxy._name).toString();
//    String url_str = "http://www.blueacepoker.com/s/handhistory?gid=" + gid.replace(" ", "%20") + "&grid=" + grid + "&pid="+ServerProxy._name;
	try {
