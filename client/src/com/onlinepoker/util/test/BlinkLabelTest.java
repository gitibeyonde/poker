...
public class BlinkLabelTest extends JLabel {
  ...
  public BlinkLabelTest(String text) {
   super(text);
  ...
  private class TimerListener implements ActionListener {
    private BlinkLabelTest bl;
    private Color bg;
    private Color fg;
    private boolean isForeground = true;
    
    public TimerListener(BlinkLabelTest bl) {
      this.bl = bl;
      fg = bl.getForeground();
      bg = bl.getBackground();
    }
  ...
  public void createAndShowUI() {
    ...
    final BlinkLabelTest bl = new BlinkLabelTest("Trying to reconnect....");
...
//      }
//    });
	  new BlinkLabelTest("trying...").createAndShowUI();
  }
  // ---
}
