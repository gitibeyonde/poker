...
/**
	 * 
	 */
	private static final long serialVersionUID = 1969648458432L;

public final static int MAX_CARDS = 54;
...
public Cards(String s) {
 ...
 public Cards(String s, String sep) {
   this();
   try {
...
public Card[] getCards(){
 Vector<Card> crds = new Vector<Card>();
 for (int i=1; i < cards[0].index+1; i++) {
   crds.add(cards[i]);
 }
...
public static void main(String args[]){
   Cards cv = new Cards("7C9C6D8D");
   System.out.println(cv);
   cv.sort(false);
   System.out.println(cv);
   //7H'AD'8S'AC'3C'TH'7C'QC'5H'AS'6S'TD<<<>>>>AC'AD'AS'QC'TD'TH'8S'7C'7H'6S'5H'3C
   cv = new Cards("7H'AD'8S'AC'3C'TH'7C'QC'5H'AS'6S'TD", "'");
   cv.sort(false);
   System.out.println(cv.openStringValue());
   cv.sort(false);
   System.out.println(cv.openStringValue());
   cv = new Cards("AC'AD'AS'QC'TD'TH'8S'7C'7H'6S'5H'3C", "'");
   cv.sort(false);
   System.out.println(cv.openStringValue());
   cv.sort(false);
   System.out.println(cv.openStringValue());
