...
public class PokerGameType  {
  ...
  public static final int Play_TeenPatti = 32;
  ...
  public static final int Real_TeenPatti = 8192;
  ...
  public static final int TU1 = 262144;
  public static final int TU2 = 524288;

  //6
  public static final int HoldemTourny = 1048576;
  public static final int OmahaTourny = 2097152;
  public static final int SGU1 = 4194304;
  public static final int SGU2 = 8388608;

  //7
  public static final int U1 = 16777216;
  public static final int U2 = 33554432;
  public static final int U3 = 67108864;
  public static final int U4 = 134217728;


  public static final int REAL_POKER = 0xFF00;
  public static final int PLAY_POKER = 0xFF;
  public static final int POKER = 0xFFFFFF;


  public static final int REGULAR_POKER_GAME = 0xFFFFF;


  private static String[] strings = new String[] {
      "Play-Holdem", "Play-OmahaHi", "Play-OmahaHiLo", "Play-StudHi",
      "Play-StudHiLo","Play_TeenPatti", "Play_Badugi", "PU",
      "Real-Holdem", "Real-OmahaHi", "Real-OmahaHiLo", "Real-StudHi",
      "Real-StudHiLo", "Real_TeenPatti", "Real_Badugi", "RU",
      "HoldemSitnGo", "OmahaSitnGo", "TU1", "TU2",
      "HoldemTourny", "OmahaTourny", "SGU1", "SGU2",
      "u1", "u2", "u3", "u4",
      "u4", "u5", "u6"
  };
...
//  }
//
//  public static final int HOLDEM = Play_Holdem | Real_Holdem | HoldemTourny;
//
...
//  }
//
//  public static final int TEENPATTI = Play_TeenPatti | Real_TeenPatti;
//
//  public boolean isTeenPatti() {
//    return (intVal & TEENPATTI) > 0;
//  }
//
//  public static final int BADUGI = Play_Badugi | Real_Badugi;
//
//  public boolean isBadugi() {
//    return (intVal & BADUGI) > 0;
//  }
//  
//  public static final int OMAHA = Play_OmahaHi | Play_OmahaHiLo | Real_OmahaHi | Real_OmahaHiLo;
...
//  }
//
//  public static final int OMAHAHI = Play_OmahaHi  | Real_OmahaHi ;
