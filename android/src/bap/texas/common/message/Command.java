...
public class Command
  ...
  public static final int C_U1 = 23;
  public static final int C_U4 = 24;
  ...
  public static final int C_BUY_TICKET = 41;
  public static final int C_BINGOROOMDETAIL = 42;
  ...
  public static final int M_SPLIT = 35;
  public static final int M_CANCEL = 36;
  public static final int M_PLAY_SEEN = 37;
  public static final int M_CALL_SHOW = 38;
  public static final int M_OPEN_ONE = 39;
  public static final int M_OPEN_TWO = 40;
  public static final int M_OPEN_THREE = 41;
  public static final int M_DD = 42;
  public static final int M_HALF = 43;
  public static final int M_FULL = 44;
  public static final int M_MORNING = 45;
  public static final int M_AFTERNOON = 46;
  public static final int M_EVENING = 47;
  public static final int M_PASS = 48;
  public static final int M_BID = 49;
  
  //CASINO MOVES
  public static final int M_CASINO_PLAY = 50;

  public static final String IP="46.228.199.184";
  ...
  public Command(HashMap<String, String> hash) {
    super(hash);
    _session = (String) _hash.get("CSID");
    _cname = Integer.parseInt( (String) _hash.get("CN"));
  }
