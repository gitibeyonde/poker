...
public class CommandTableList
  ...
  public CommandTableList(String session, int type, String aff, String plyrs,
                          int level) {
    super(session, Command.C_TABLELIST);
    _type = type;
    _affiliate = aff;
    _player = plyrs;
    _level = level;
  ...
  public CommandTableList(String session, int type) {
    super(session, Command.C_TABLELIST);
    _type = type;
    _affiliate = "admin";
    _player = null;
  ...
  public CommandTableList(String session) {
	  super(session, Command.C_TABLELIST);
	    //_type = type;
	    _affiliate = "admin";
	    _player = null;
  ...
  public CommandTableList(HashMap<String, String> str) {
    super(str);
