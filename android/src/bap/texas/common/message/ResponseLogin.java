...
public class ResponseLogin
  ...
  private Vector<String> _tidv;
  private Vector<String> _posv;
  ...
  public ResponseLogin(int result, int ug, double uw, String avtr, double urw,
                       String city, int prf, int rank, int all_in, double rll, Vector<String> tidv,
                       Vector<String> posv) {
    super(result, R_LOGIN);
    _ug = ug;
    _uw = uw;
  ...
  public ResponseLogin(HashMap<String, String> str) {
    super(str);
    if (getResult() == 1 ) {
