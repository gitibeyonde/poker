...
public class GameEvent {
  protected HashMap<String, String> _ge;
  ...
  public int getPlayerCount() {
    ...
    try {
      ...
      String plrs_det[] = p.split("`");
      plrs = new String[plrs_det.length][7];
      return plrs_det.length;
    }
    catch (Exception e) {
    	return 0;
    }
  ...
  public double getAveragePot() {
    String ts = (String) _ge.get("average-pot");
    if (ts != null) {
  ...
  public String toString() {
	if (_ge == null) return "";
    Iterator<String> e = _ge.keySet().iterator();
