...
public class RealHoldemSitnGo
    extends HoldemSitnGo {
  // set the category for logging
  static Logger _cat = Logger.getLogger(HoldemSitnGo.class.getName());


  public RealHoldemSitnGo(String name, int minPlayers, int maxPlayers,
                      int limit, int tourbo,
                      String[] affiliate,
                      Observer stateObserver) {
    super(name, minPlayers, maxPlayers, limit, tourbo, affiliate,  stateObserver);
    _type = new PokerGameType(PokerGameType.Real_HoldemSitnGo);
  }
